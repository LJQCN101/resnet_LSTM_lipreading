...
def bbc(vidframes, augmentation=True, channel=3):
    ...
    if channel == 3: temporalvolume = torch.FloatTensor(3, num_frames, final_crop_size, final_crop_size)
    elif channel == 1: temporalvolume = torch.FloatTensor(1, num_frames, final_crop_size, final_crop_size)
    ...
    for frame_index in range(0, num_frames):
        ...
        # print(result.shape)
        if channel == 1: temporalvolume[0][frame_index] = result
        elif channel == 3:
